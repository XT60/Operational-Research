...
class BeesAlgorithm:
    ...
    def local_search(self, cube):
        ...
        for _ in range(self.num_local_searches):
            ...
            # if candidate_fitness <= self.score_threshold:
            #     candidate.make_alg("random_moves_algs_moves_prim", move_count=random.randint(1, 6))
            # else:
            #     candidate.make_alg("random_moves_algs_moves_prim", move_count=random.randint(1, 4))
    ...
    def global_search(self):
        ...
        for i in tqdm.tqdm(range(self.num_scouts), desc="global_search"):
            ...
            # if new_cube.get_score()[0] <= self.score_threshold:
            #     new_cube.make_alg("random_moves_algs_moves_prim", move_count=random.randint(1, 30))
            # else:
            #     new_cube.make_alg("random_algs", move_count=random.randint(0, 60))
            #     new_cube.make_alg("random_moves_algs_moves_prim", move_count=random.randint(1, 40))
